...
public class FormularioDos extends JFrame {
    ...
    lblDescripcinDelArtculo.setBounds(100, 38, 200, 14);
    ...
    lblPrecio.setBounds(200, 74, 95, 14);
  ...
  int cantidad = comando.executeUpdate("DELETE FROM articulos WHERE codigo="+tf3.getText());
    ...
    */
    btnBorrar.setBounds(400, 156, 177, 23);
    ...
    btnModificar.setBounds(400, 190, 179, 23);
